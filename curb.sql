...
CREATE TABLE `qianggoubiao` (
  ...
  `logo` varchar(255) DEFAULT NULL,
  `remark` varchar(255) DEFAULT NULL,
  `directe_url` varchar(255) NOT NULL,
  `is_invalid` char(255) DEFAULT NULL,
  `create_user` varchar(255) DEFAULT NULL,
  `qianggoubiao_time` varchar(255) DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `qianggoubiao` VALUES ('5', '小米6', '2017-08-01 17:15:27', '', '', 'https://item.jd.com/4099139.html', '', '', '10:08', '1', '1');
INSERT INTO `qianggoubiao` VALUES ('6', '荣耀8', '2017-08-01 23:24:52', null, null, 'https://item.jd.com/4099139.html', null, null, '12:00', '1', '1');
